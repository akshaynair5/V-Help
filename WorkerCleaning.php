...
<head>
    ...
    <title>Room cleaning requests</title>
...
<body>
    <div id="homeBox">
        ...
        <div class="content">
            <h1>Cleaning Problems reported:</h1>
            ...
            $query1 = mysqli_query($conn, "SELECT * FROM `complains` WHERE `Status`='pending' && `prob_type`='cle'");
            $query2 = mysqli_query($conn, "SELECT * FROM `complains` WHERE `Status`='accepted' && `prob_type`='cle' && worker_id='$regno1'");
            ...
            <table class="table" id="table" border="1">
                ...
                ?>
                    ...
                    if (isset($_POST["take"])) {
                        ...
                        // $id = $_POST['id'];
                        $regno1 = $_SESSION["regno"];
                        $query21 = "UPDATE complains SET `Status`='accepted' , `worker_id`= '$regno1' WHERE id='$id' && `prob_type`='cle'";
